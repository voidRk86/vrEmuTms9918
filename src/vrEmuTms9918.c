  ...
  const bool isTile2)
{
  ...
  else if (shift)
  {
    ...
    {
      case 1:
        quadPixels = rederEcmShiftedTile(quadPixels, tilePixels, pattMask, 8, 24);
        break;
      case 2:
        quadPixels = rederEcmShiftedTile(quadPixels, tilePixels, pattMask, 16, 16);
        break;
      default:
        quadPixels = rederEcmShiftedTile(quadPixels, tilePixels, pattMask, 24, 8);
        break;
    }
  }
